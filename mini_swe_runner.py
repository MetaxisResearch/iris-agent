#!/usr/bin/env python3
"""
Mini-SWE-Agent Runner with Iris Trajectory Format

This module provides a runner that uses mini-swe-agent's execution environments
(local, docker, modal) but outputs trajectories in the iris-agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses mini-swe-agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Iris format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches iris-agent format)
# ============================================================================
...
# ============================================================================
# Mini-SWE Runner with Iris Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses mini-swe-agent environments but outputs
    trajectories in iris-agent format.
    """
    ...
    def _convert_to_Iris_format(
        ...
        """
        Convert internal message format to Iris trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Iris trajectory format
        trajectory = self._convert_to_Iris_format(messages, task, completed)
...
def main(
    ...
    """
    Run mini-swe-agent tasks with Iris trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Iris Trajectory Format")
    print("=" * 60)
