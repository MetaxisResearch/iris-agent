 ...
 *
 * Usage:
 *   node bridge.js --port 3000 --session ~/.Iris/whatsapp/session
 */
...
const SESSION_DIR = getArg('session', path.join(process.env.HOME || '~', '.Iris', 'whatsapp', 'session'));
...
async function startSocket() {
  ...
  sock = makeWASocket({
    ...
    browser: ['Iris Agent', 'Chrome', '120.0'],
