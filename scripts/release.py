...
AUTHOR_MAP = {
    ...
    "teknium@Metaxis Research.com": "teknium1",
    ...
    "shannon@Metaxis Research.com": "shannonsands",
    ...
    "Iris@Metaxis Research.com": "Metaxis Research",
...
def generate_changelog(commits, tag_name, semver, repo_url="https://github.com/Metaxis Research/iris-agent",
...
def main():
    ...
    print(f"{'='*60}")
    print(f"  Iris Agent Release Preview")
    print(f"{'='*60}")
    ...
    if args.publish:
        ...
        if result.returncode == 0:
            ...
            print(f"    gh release create {tag_name} --title 'Iris Agent v{new_version} ({calver_date})'")
