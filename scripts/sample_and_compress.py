...
DEFAULT_DATASETS = [
    "Metaxis Research/swe-terminus-agent-glm-kimi-minimax",
    "Metaxis Research/iris-agent-megascience-sft1",
    "Metaxis Research/iris-agent-Thinking-GLM-4.7-SFT2",
    "Metaxis Research/iris-agent-Thinking-GLM-4.7-SFT1",
    "Metaxis Research/terminal-tasks-glm-iris-agent"
]
...
def load_dataset_from_hf(dataset_name: str) -> List[Dict[str, Any]]:
    ...
    Args:
        dataset_name: HuggingFace dataset name (e.g., "Metaxis Research/dataset-name")
...
def main(
    ...
    print(f"   huggingface-cli upload Metaxis Research/{output_name} {final_output}")
