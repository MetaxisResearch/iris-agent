...
metadata:
  Iris:
    ...
    related_skills: [claude-code, iris-agent]
---

# Codex CLI

Delegate coding tasks to [Codex](https://github.com/openai/codex) via the Iris terminal. Codex is OpenAI's autonomous coding agent CLI.
