...
metadata:
  Iris:
    ...
    related_skills: [codex, iris-agent]
---

# Claude Code

Delegate coding tasks to [Claude Code](https://docs.anthropic.com/en/docs/claude-code) via the Iris terminal. Claude Code is Anthropic's autonomous coding agent CLI.
