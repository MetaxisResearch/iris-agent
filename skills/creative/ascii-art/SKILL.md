...
```bash
python3 -m pyfiglet "Iris" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=Iris&font=Slant" | boxes -d stone
```
