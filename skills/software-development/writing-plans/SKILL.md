...
version: 1.1.0
author: Iris Agent (adapted from obra/superpowers)
license: MIT
metadata:
  Iris:
...
> **For Iris:** Use subagent-driven-development skill to implement this plan task-by-task.
...
Use Iris tools to understand the project:
