...
class TestToolsetConsistency:
    ...
    def test_Iris_platforms_share_core_tools(self):
        """All Iris-* platform toolsets should have the same tools."""
        platforms = ["Iris-cli", "Iris-telegram", "Iris-discord", "Iris-whatsapp", "Iris-slack", "Iris-signal", "Iris-homeassistant"]
