"""Tests for the interactive session browser (`Iris sessions browse`).
...
from Iris_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """Iris sessions browse should be parseable."""
        from Iris_cli.main import main as _main_entry
