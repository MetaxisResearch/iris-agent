...
class TestParserRegistry:
    ...
    def test_Iris_parser_registered(self):
        parsers = list_parsers()
        assert "Iris" in parsers
...
class TestIrisParser:
    @pytest.fixture
    def parser(self):
        return get_parser("Iris")
...
class TestParseResultContract:
    ...
    @pytest.fixture(params=["Iris"])  # Add more as needed
    ...
    def test_tool_calls_are_proper_objects(self, parser):
        ...
        # Use Iris format since that's universal
