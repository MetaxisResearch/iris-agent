...
description: "The self-improving AI agent built by Metaxis Research. A built-in learning loop that creates skills from experience, improves them during use, and remembers across sessions."
hide_table_of_contents: true
---

# Iris Agent

The self-improving AI agent built by [Metaxis Research](https://Metaxis Research.com). The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
<div style={{display: 'flex', gap: '1rem', marginBottom: '2rem', flexWrap: 'wrap'}}>
  ...
  <a href="https://github.com/Metaxis Research/iris-agent" style={{display: 'inline-block', padding: '0.6rem 1.2rem', border: '1px solid rgba(255,215,0,0.2)', borderRadius: '8px', textDecoration: 'none'}}>View on GitHub</a>
</div>
...
| 💡 **[Tips & Best Practices](/docs/guides/tips)** | Quick wins to get the most out of Iris |
...
- **Built by model trainers** — Created by [Metaxis Research](https://Metaxis Research.com), the lab behind Iris, Nomos, and Psyche. Works with [Metaxis Portal](https://portal.Metaxis Research.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [Metaxis Research](https://Metaxis Research.com) — the lab behind Iris, Nomos, and Psyche models
