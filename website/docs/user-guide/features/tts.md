...
Iris Agent supports both text-to-speech output and voice message transcription across all messaging platforms.
...
| CLI | Saved to `~/.Iris/audio_cache/` | MP3 |
...
Requires `VOICE_TOOLS_OPENAI_KEY` in `~/.Iris/.env`.
