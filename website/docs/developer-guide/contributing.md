...
sidebar_position: 4
title: "Contributing"
description: "How to contribute to Iris Agent — dev setup, code style, PR process"
---

# Contributing

Thank you for contributing to Iris Agent! This guide covers setting up your dev environment, understanding the codebase, and getting your PR merged.
...
Iris officially supports Linux, macOS, and WSL2. Native Windows is **not supported**, but the codebase includes some defensive coding patterns to avoid hard crashes in edge cases. Key rules:
...
- **Discord**: [discord.gg/Metaxis Research](https://discord.gg/Metaxis Research)
- **GitHub Discussions**: For design proposals and architecture discussions
- **Skills Hub**: Upload specialized skills and share with the community

## License

By contributing, you agree that your contributions will be licensed under the [MIT License](https://github.com/Metaxis Research/iris-agent/blob/main/LICENSE).
