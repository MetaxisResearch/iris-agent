...
def register_parser(name: str):
    ...
    Usage:
        @register_parser("Iris")
        class IrisToolCallParser(ToolCallParser):
            ...
    """
...
def get_parser(name: str) -> ToolCallParser:
    ...
    Args:
        name: Parser name (e.g., "Iris", "mistral", "llama3_json")
...
from environments.tool_call_parsers.Iris_parser import IrisToolCallParser  # noqa: E402, F401
