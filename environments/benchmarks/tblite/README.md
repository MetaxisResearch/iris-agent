...
- **Dataset (ours):** [Metaxis Research/openthoughts-tblite](https://huggingface.co/datasets/Metaxis Research/openthoughts-tblite)
- **Docker images:** `Metaxis Research/tblite-<task-name>:latest` on Docker Hub (100 images)
...
| Setting        | TB2                              | TBLite                                  |
|----------------|----------------------------------|-----------------------------------------|
| Dataset        | `Metaxis Research/terminal-bench-2`  | `Metaxis Research/openthoughts-tblite`      |
| Tasks          | 89                               | 100                                     |
