"""
IrisSweEnv -- SWE-Bench Style Environment with Modal Sandboxes
...
Usage:
    ...
    vllm serve YourModel --tool-parser Iris
    run-api
    python environments/Iris_swe_env.py serve \\
...
class IrisSweEnv(IrisAgentBaseEnv):
    ...
    name = "Iris-swe"
    env_config_cls = IrisSweEnvConfig

    @classmethod
    def config_init(cls) -> Tuple[IrisSweEnvConfig, List[APIServerConfig]]:
        """
        ...
        env_config = IrisSweEnvConfig(
            ...
            # Atropos settings
            group_size=4,
            tokenizer_name="Metaxis Research/DeepIris-3-Llama-3-3B-Preview",
            tool_call_parser="Iris",
            steps_per_eval=50,
            total_steps=500,
            use_wandb=True,
            wandb_name="Iris-swe",
        ...
        server_configs = [
            APIServerConfig(
                ...
                model_name="Metaxis Research/DeepIris-3-Llama-3-3B-Preview",
