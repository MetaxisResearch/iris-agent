...
Inspired by: GroceryMind — production Iris agent doing live web research
             across German grocery stores (firecrawl + iris-agent)
"""
...
# Ensure iris-agent root is on path
...
class WebResearchEnvConfig(IrisAgentEnvConfig):
...
class WebResearchEnv(IrisAgentBaseEnv):
    """
