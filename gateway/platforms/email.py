"""
Email platform adapter for the Iris gateway.

Allows users to interact with Iris by sending emails.
...
class EmailAdapter(BasePlatformAdapter):
    ...
    def _send_email(
        ...
        subject = ctx.get("subject", "Iris Agent")
        ...
        msg_id = f"<Iris-{uuid.uuid4().hex[:12]}@{self._address.split('@')[1]}>"
