...
class DiscordAdapter(BasePlatformAdapter):
    ...
    def _register_slash_commands(self) -> None:
        ...
        @tree.command(name="ask", description="Ask Iris a question")
        @discord.app_commands.describe(question="Your question for Iris")
        ...
        @tree.command(name="reset", description="Reset your Iris session")
        ...
        @tree.command(name="status", description="Show Iris session status")
        ...
        @tree.command(name="stop", description="Stop the running Iris agent")
        ...
        @tree.command(name="update", description="Update Iris Agent to the latest version")
