...
Trust levels:
  - builtin:   Ships with Iris. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.Iris/\.env|\~/\.Iris/\.env',
     "Iris_env_access", "critical", "exfiltration",
     "directly references Iris secrets file"),
    ...
    (r'\.Iris/config\.yaml|\.Iris/SOUL\.md',
     "Iris_config_mod", "critical", "persistence",
     "references Iris configuration files directly"),
...
def _get_configured_model() -> str:
    """Load the user's configured model from ~/.Iris/config.yaml."""
    try:
