...
_OUTPUT_FENCE = "__Iris_FENCE_a9f7b3__"
...
def _find_bash() -> str:
    ...
    custom = os.environ.get("Iris_GIT_BASH_PATH")
    ...
    raise RuntimeError(
        "Git Bash not found. Iris Agent requires Git for Windows on Windows.\n"
        "Install it from: https://git-scm.com/download/win\n"
        "Or set Iris_GIT_BASH_PATH to your bash.exe location."
    )
