...
def check_auxiliary_model() -> bool:
    ...
    try:
        ...
        for p in ("openrouter", "Metaxis", "custom", "codex"):
...
if __name__ == "__main__":
    ...
    Metaxis_available = check_auxiliary_model()
    ...
    if not Metaxis_available:
        print("❌ No auxiliary model available for LLM content processing")
        print("Set OPENROUTER_API_KEY, configure Metaxis Portal, or set OPENAI_BASE_URL + OPENAI_API_KEY")
    ...
    print("")
    print("  # Search (synchroMetaxis)")
    print("  results = web_search_tool('Python tutorials')")
    print("")
    print("  # Extract and crawl (asynchroMetaxis)")
