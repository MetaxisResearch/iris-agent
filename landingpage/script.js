// =========================================================================
// Iris Agent Landing Page — Interactions
// =========================================================================

// --- Platform install commands ---
const PLATFORMS = {
    linux: {
        command: 'curl -fsSL https://raw.githubusercontent.com/Metaxis Research/iris-agent/main/scripts/install.sh | bash',
        prompt: '$',
...
const demoSequence = [
    ...
    { type: 'clear' },
    { type: 'prompt', text: '❯ ' },
    { type: 'type', text: 'Review the PR at Metaxis Research/iris-agent#42 and fix any issues', delay: 30 },
    { type: 'pause', ms: 600 },
    { type: 'output', lines: [
        '',
